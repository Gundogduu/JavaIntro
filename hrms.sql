...
CREATE TABLE public.candidates(
	...
	CONSTRAINT uc_candidates_national_identity UNIQUE(national_identity)
);
...
CREATE TABLE public.verification_code_candidates(
	...
	CONSTRAINT pk_verification_code_candidates PRIMARY KEY(verification_id),
	CONSTRAINT fk_verification_code_candidates_verification_codes 
	FOREIGN KEY(verification_id) REFERENCES public.verification_codes(id),
...
CREATE TABLE public.verification_code_employers(
	...
	CONSTRAINT pk_verification_code_employers PRIMARY KEY(verification_id),
...
CREATE TABLE public.employee_confirms(
	...
	FOREIGN KEY(employee_id) REFERENCES public.employers(user_id)
);

CREATE TABLE public.employee_confirm_employers(
	confirm_id INT NOT NULL,
	employer_id INT NOT NULL,
	CONSTRAINT pk_employee_confirm_employers PRIMARY KEY(confirm_id),
	CONSTRAINT fk_employee_confirm_employers_employee_confirms 
	FOREIGN KEY(confirm_id) REFERENCES public.employee_confirms(id),
